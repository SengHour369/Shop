...
public class CateoryService implements CateoryServiceTemp {
    ...
    @Override
    public CateoryResponseDTO updateCateory(Long id, CateoryRequestDTO cateoryRequestDTO) {
        return null;
    }

    @Override
    public CateoryResponseDTO deleteCateoryById(Long id) throws ExceptionHandlerNotFound {
                var category = cateoryRepository.findById(id)
